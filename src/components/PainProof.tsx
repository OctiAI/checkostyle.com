        ...
        >
          ...
          <div className="w-full flex justify-end">
            <div className="relative group inline-block">
              ...
              <div className="absolute right-0 mt-0 w-[680px] text-sm text-white bg-gray-900 px-4 py-2 rounded-md shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-50">
