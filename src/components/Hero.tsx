    ...
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-blue-50 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-24 sm:pb-16">
        ...
        <div className="flex flex-col items-center">
            <motion.button
              className="w-full sm:w-auto bg-[#E63946] text-white px-8 py-4 rounded-full font-bold text-lg flex items-center justify-center space-x-2 px-16 shadow-lg hover:shadow-xl border border-gray-200 transition-all duration-300 mb-4" 
