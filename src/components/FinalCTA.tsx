    ...
    <section className="py-20 bg-gradient-to-br from-red-50 to-orange-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <div className="bg-white rounded-2xl p-6 text-center border-2 border-red-200 shadow-lg hover:shadow-[0_0_5px_rgba(255,223,93,0.6)] transition-shadow duration-300 transition-transform duration-300 hover:scale-[1.05]" >
          ...
          <div className="bg-white rounded-2xl p-6 text-center border-2 border-orange-200 shadow-lg hover:shadow-[0_0_5px_rgba(255,223,93,0.6)] transition-shadow duration-300 transition-transform duration-300 hover:scale-[1.05]">                                
            
           <div className="w-full flex justify-end">
  <div className="relative group inline-block">
    <div className="w-6 h-6 text-gray-800 rounded-full flex items-center justify-center text-xl cursor-default">
      ⓘ
    </div>
...
>
  ...
  >
    ...
    <span>Book a Setup Call</span>
           ...
           <p className="text-md text-gray-700 max-w-10xl text-center mb-12">
