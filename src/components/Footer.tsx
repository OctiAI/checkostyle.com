      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="col-span-4 md:col-span-2">
            ...
            <div className="flex space-x-6">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-300">Stripe Secure</span>
              </div>
              <div className="flex items-center space-x-2">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 text-gray-400 mt-4 md:mt-0">
            ...
            <a href="https://checkostyle.com/Privacy%20Policy.pdf" className="hover:text-white transition-colors">Cookies</a>
          </div>
        </div>
    </footer>
  );
