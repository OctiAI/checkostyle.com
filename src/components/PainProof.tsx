  ...
  return (
    <section className="py-20 bg-white">
      ...
      <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
        ...
        <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-500 to-green-600"> Here’s What They Do Like:</span> 
        </h2>
        ...
        >
          ...
          <div className="w-full flex justify-end mt-0">
            <div className="relative group inline-block">
              ...
              <div className="absolute right-0 mt-0 w-[280px] text-sm text-white bg-gray-900 px-4 py-2 rounded-md shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-50">
