    ...
    <form onSubmit={handleSubmit} className="space-y-6">
     ...
     <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
          ...
          switch (window.location.search.replace('?', '')) {
            ...
            case 'CS_checko_pro_y':
               return(   
                <div className="flex justify-between items-center">
                 <span>CheckoStyle Pro Plan</span>  
                <span className="font-bold text-green-600">$948.00</span>
              </div>)            
               ...
               return(  
                 <div>
                    <div className="flex justify-between items-center">
                     ...
                     <div className="flex justify-between items-center">
                     <span>CheckoStyle Pro Plan</span>
                    <span className="font-bold text-green-600">$79.00</span>
                  </div>
                </div>)   
            ...
            case 'CS_checko_enterprise_m':
              return (<div className="flex justify-between items-center">
                 <span>Refundable Scheduling Fee</span> 
      ...
      <p className="text-xs text-gray-500 text-center">
        ...
        <a href="https://checkostyle.com/Terms%20of%20Service.pdf" className="text-green-600 underline">Terms of Service</a> &{' '}
        <a href="https://checkostyle.com/Privacy%20Policy.pdf" className="text-green-600 underline">Privacy Policy</a>.
      </p>
    </form>
  );
};
