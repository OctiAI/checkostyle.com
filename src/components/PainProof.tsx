            ...
            <div className="bg-gray-50 rounded-2xl p-8 border-2 border-red-200">
              ...
              <div className="mt-4 space-y-2 text-sm text-gray-500">
                <div className="flex items-center justify-around">
                  <span className="w-[160px] ml-10">❌ No branding</span>
                  <span className="w-[160px]">❌ Generic design</span>
                </div>
                <div className="flex items-center justify-around">
                  <span className="w-[160px] ml-10">❌ Low trust signals</span>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-8 border-2 border-green-200">
              ...
              <div className="mt-4 space-y-2 text-sm text-green-700">
                <div className="flex items-left justify-around">
                  <span className="w-[160px]  ml-20">✅ 100% Secure</span>
                  <span className="w-[200px]">✅ Drag & Drop Builder</span>
                </div>
                <div className="flex items-left justify-around">
                  <span className="w-[160px] ml-20">✅ Trust signals</span>
